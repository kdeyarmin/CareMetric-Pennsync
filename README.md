...
- `VITE_CENTRAL_HELP_ENABLED` — first-party Support Hub rollout flag; only the exact value `true` shows the central launcher. `/Help` remains available as the local fallback.
