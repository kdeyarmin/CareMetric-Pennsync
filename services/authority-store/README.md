...
| `20260920050000_patient_purpose_policy.sql` | Not a contract: the authorized-patient purpose policies as pure functions, with no authorization in them at all. Generated by `node tools-patient-purpose-policy.mjs --write` from the fenced blocks in the two originals, because sixteen field lists are data and retyping them is the transcription D12 settled against |
