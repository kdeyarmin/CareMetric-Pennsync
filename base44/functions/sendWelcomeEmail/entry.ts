...
Deno.serve(async (req) => {
  try {
    ...
    const welcomeEmail = await base44.integrations.Core.SendEmail({
      to: email,
      subject: 'Welcome to PennSync - Your Account is Ready',
      from_name: 'PennSync Admin',
      body: `Dear ${full_name},

Welcome to PennSync! Your user account has been set up by your administrator.
...
GETTING STARTED:
1. Visit the PennSync login page and sign in with the credentials above
  2. You will be prompted to change your temporary password to a secure password of your choice
  3. Once logged in, you'll have access to the PennSync platform
