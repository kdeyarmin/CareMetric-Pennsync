...
Deno.serve(async (req) => {
  try {
    ...
    await base44.asServiceRole.integrations.Core.SendEmail({
      ...
      subject: 'Your PennSync by CareMetric Account is Ready – You Can Now Log In',
      body: `Dear ${full_name},

Great news! Your PennSync by CareMetric account has been fully verified and activated. You can now log in at any time.
