...
| `records_schema` | 41 | Nothing that is not committed. The store migration and the broker family exist; each of these needs its own reviewed contract on D19's pattern. This is the tier to start |
