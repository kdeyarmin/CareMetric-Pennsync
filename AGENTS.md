...
| Patient purpose policy (gate) | `pnpm run check:patient-purpose-policy` |
...
| Re-extract the patient purpose policy | `node tools-patient-purpose-policy.mjs --write` |
