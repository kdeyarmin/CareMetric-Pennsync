...
export default [
  ...
  {
    files: ['services/authority-client/**/*.mjs', 'services/authority-store/**/*.mjs', 'services/integration-runtime/tests/**/*.mjs', 'tools-pennsync-archive*.mjs', 'tools-pennsync-cutover*.mjs'],
    languageOptions: { globals: globals.node },
    rules: pluginJs.configs.recommended.rules,
  },
  {
