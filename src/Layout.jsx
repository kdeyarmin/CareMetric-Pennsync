...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    ...
    <div className="min-h-screen bg-blue-100 dark:bg-gray-900 flex overflow-x-hidden transition-colors duration-300 relative">
      ...
      <header
        className={`lg:hidden fixed top-0 left-0 right-0 bg-gray-600 shadow-lg flex flex-col transition-colors duration-300 ${
      ...
      >
        {showNavigationUI && (
          <div
            className="flex items-center justify-between px-2 sm:px-3 w-full bg-gray-600"
