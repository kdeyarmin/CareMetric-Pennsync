...
import ComprehensiveDocumentReview from './ComprehensiveDocumentReview';
...
export default function DocumentPreview({ document, onClose, onSave, onSend, saving, patient }) {
  ...
  // Removed old reviewMutation as ComprehensiveDocumentReview handles it internally
    ...
    <div className="space-y-6">
      ...
      <TabsContent value="review" className="mt-6">
        <ComprehensiveDocumentReview
          documentContent={editedContent || document.generated_content}
          documentType={document.template_type}
