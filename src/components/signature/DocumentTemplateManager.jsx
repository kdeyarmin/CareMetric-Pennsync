...
export default function DocumentTemplateManager() {
  ...
  const createMutation = useMutation({
    mutationFn: (data) => base44.entities.DocumentSignatureTemplate.create(data),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (data) => base44.entities.DocumentSignatureTemplate.update(editingTemplate.id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["documentTemplates"] });
