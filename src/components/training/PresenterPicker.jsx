...
export default function PresenterPicker({
  ...
  // Configured but the catalog fetch failed — keep the old raw-ID inputs so
  // admins are never blocked on a HeyGen listing hiccup.
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <p className="sm:col-span-2 text-xs text-slate-400">
          Couldn’t load the avatar &amp; voice catalog — you can still paste IDs from your HeyGen account, or leave blank for the defaults.
        </p>
      </div>
    );
  }
