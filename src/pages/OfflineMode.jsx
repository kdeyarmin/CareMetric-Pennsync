...
import EnhancedOfflineSync from "../components/mobile/EnhancedOfflineSync";
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs sm:text-sm text-gray-600 truncate">Work without internet, sync when ready</p>
          </div>
        </div>

        <Alert className={isOnline ? 'bg-green-50 border-green-300' : 'bg-orange-50 border-orange-300'}>
          <AlertDescription className="text-xs sm:text-sm flex items-center gap-2 flex-wrap">
            {isOnline ? (
              <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6">
        <Card className="border-blue-200">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm text-blue-600 font-medium mb-1">Cached Patients</p>
        ...
        <Card className="border-yellow-200">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm text-yellow-600 font-medium mb-1">Pending Sync</p>
        ...
        <Card className="border-purple-200">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm text-purple-600 font-medium mb-1">Storage Used</p>
              ...
              <Database className="w-8 h-8 sm:w-10 sm:h-10 text-purple-400" />
            </div>
          </CardContent>
        </Card>
      </div>
            ...
            <CardContent className="p-3 sm:p-4">
              {cachedPatients.length === 0 ? (
                <div className="text-center py-8 sm:py-12 text-gray-500">
                  ...
                  <p className="text-[10px] sm:text-xs mt-1">Download patient data to work offline</p>
                </div>
              ) : (
                <div className="space-y-2 max-h-96 overflow-y-auto">
                  {cachedPatients.map((cache, idx) => (
                    ...
                    >
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 line-clamp-1">{cache.patient.primary_diagnosis}</p>
