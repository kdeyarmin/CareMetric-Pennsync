...
export default function About() {
  const keyBenefits = [
    {
      ...
      description: "AI-powered documentation automation reduces charting time by 60-70%, giving you more time for patient care.",
  ...
  const timeMetrics = [
    ...
    { label: "Documentation Time Reduction", value: "60-70%", icon: Zap, color: "text-green-600" },
