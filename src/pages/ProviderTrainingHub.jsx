...
const FEATURED_MODULES = [
  {
    id: "smart-notes-101",
    title: "Smart Notes 101",
    description: "Learn to leverage AI for faster, more compliant documentation",
    category: "Smart Notes",
    duration: 15,
    difficulty: "Beginner"
  },
  {
    id: "ai-scribe-mastery",
    title: "AI Scribe Mastery",
    description: "Master voice dictation and AI-powered note generation",
    category: "AI Features",
    duration: 20,
    difficulty: "Intermediate"
  },
  {
    id: "care-plan-optimization",
    title: "Care Plan Optimization",
    description: "Use AI to create better, more effective care plans",
    category: "Care Planning",
    duration: 25,
    difficulty: "Intermediate"
  },
  {
    id: "oasis-compliance-pro",
    title: "OASIS Compliance Pro",
    description: "Ensure perfect Medicare compliance with AI assistance",
    category: "Compliance",
    duration: 30,
    difficulty: "Advanced"
  }
